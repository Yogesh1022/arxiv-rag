-- Enable extensions (for arxiv_rag DB)
...
-- Grant privileges
GRANT ALL PRIVILEGES ON DATABASE arxiv_rag TO arxiv;
GRANT ALL PRIVILEGES ON DATABASE airflow TO arxiv;
GRANT ALL PRIVILEGES ON DATABASE langfuse TO arxiv;
